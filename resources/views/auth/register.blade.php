...
@section('title_tag','Đăng ký tài khoản mới - WATCHPRO')
@section('content')
<div class="container">
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading text-center"><h2 class="title-login">Đăng ký tài khoản mới</h2></div>
            ...
            <div class="alert alert-{{Session('flash_level')}}">{{Session('flash_massage')}}</div>
            @endif
        </div>
    </div>
</div>
