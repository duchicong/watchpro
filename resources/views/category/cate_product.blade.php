...
@section('title_tag')
{!!$cat_pro->ten_loai_san_pham!!}
@stop
@section('content')
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
  <ul class="breadcrumb">
    <li><a href="{!!url('/')!!}"><i class="fa fa-home"></i> Trang Chủ</a></li>
    <li><a href="javascript:void(0)">{!!$cat_pro->ten_loai_san_pham!!}</a></li>
  </ul>
</div>
<div class="row">
  <div class="col-md-12">
  <div class="categories col-xs-12 col-sm-9 col-md-9 col-lg-9 pull-right">
    ...
    @foreach($pro as $row)
    <?php $i++; ?>
    <div class="product-cate col-xs-12 col-sm-4 col-md-4 col-lg-4 no-padding">
