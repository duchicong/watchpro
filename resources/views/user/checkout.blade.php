      ...
      <div class="column-block">
        <div class="column-block">
          ...
          <div class="category_block">
            ...
            <li><a href="#" class="activSub">Đồng Hồ Nam</a>
            </li>
            <li><a href="#" class="activSub">Đồng Hồ Citizen</a>
            </li>
            <li><a href="#" class="activSub">Đồng Hồ OP</a>
            </li>
            <li><a href="#" class="activSub">Đồng Hồ Orient</a>
            </li>
            <li><a href="#" class="activSub">Đồng Hồ Casio</a>
            </li>
            <li><a href="#" class="activSub">Đồng Hồ Titan</a>
            </li>
            <li><a href="#" class="activSub">Đồng Hồ Nữ</a>
            </li>
          </ul>
          </div>
        </div>
              ...
              <div class="row">
                ...
                <div class="col-sm-6">
                  ...
                  <div class="form-group">
                    ...
                    <a href="http://localhost/opc001/index.php?route=account/forgotten">Quên Mật Khẩu</a></div>
