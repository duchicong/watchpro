...
@section('title_tag_admin','WatchPro Management')
@section('content')
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<?php 
          $order = DB::table('dat_hang')->count('*'); 
          $order_new = DB::table('dat_hang')->where('trang_thai',0)->count('*'); 
          $mem = DB::table('users')->count('*');            
          $pro = DB::table('sanpham')->count('*');            
			...
			<div class="col-xs-6 col-md-3">
				<div class="panel panel-default">
					<div class="panel-body easypiechart-panel">
						<h4>Đơn hàng mới</h4>
						<div class="easypiechart" id="easypiechart-blue" data-percent="50" ><span class="percent">%</span>
						</div>
					</div>
				</div>
			</div>
